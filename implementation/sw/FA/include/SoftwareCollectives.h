...
// Log Tree
inline void swcoll_logtree_broadcast_rowwise(FlatAttentionInfo* info, uint32_t offset, uint32_t size){
...
inline void swcoll_logtree_broadcast_colwise(FlatAttentionInfo* info, uint32_t offset, uint32_t size){
...
inline void swcoll_logtree_redmax_rowwise(FlatAttentionInfo* info, uint32_t offset, uint32_t size){
...
inline void swcoll_logtree_redsum_rowwise(FlatAttentionInfo* info, uint32_t offset, uint32_t size){
    if (info->cluster_pos.x % 2 == 0)
    {
        //1. load from left
        if (flex_is_dm_core())
...
// Multi Unicast
inline void swcoll_multiunicast_broadcast_rowwise(FlatAttentionInfo* info, uint32_t offset, uint32_t size){

}

inline void swcoll_multiunicast_broadcast_colwise(FlatAttentionInfo* info, uint32_t offset, uint32_t size){

}

inline void swcoll_multiunicast_redmax_rowwise(FlatAttentionInfo* info, uint32_t offset, uint32_t size){

}

inline void swcoll_multiunicast_redsum_rowwise(FlatAttentionInfo* info, uint32_t offset, uint32_t size){
