...
parser = argparse.ArgumentParser(description="Generate C header files from a MoEDispatch configuration file.")
parser.add_argument("input_file",  nargs="?", help="Path to MoEDispatch configuration python file")
parser.add_argument("output_file", nargs="?", help="Path to MoEDispatch configuration C header file")
...
moed = MoEDispatch()
kc.generate_config_C_header("moed", moed, C_header_file, moed.dtype, moed.moed_numer)
