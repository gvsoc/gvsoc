...
def acti_check_results():
    # Set up argument parser
    parser = argparse.ArgumentParser(description="Check numerical correctness for Activation.")
    ...
    #Check Results
    num_util.check_results(args.result_path, acti.dtype)
    pass
