...
parser = argparse.ArgumentParser(description="Generate C header files from a MoEGate configuration file.")
parser.add_argument("input_file",  nargs="?", help="Path to MoEGate configuration python file")
parser.add_argument("output_file", nargs="?", help="Path to MoEGate configuration C header file")
...
moeg = MoEGate()
kc.generate_config_C_header("MOEG", moeg, C_header_file, moeg.dtype, moeg.moeg_numer)
