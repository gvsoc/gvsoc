...
def moec_check_results():
    # Set up argument parser
    parser = argparse.ArgumentParser(description="Check numerical correctness for MoECombine.")
    ...
    #Check Results
    num_util.check_results(args.result_path, moec.dtype)
    pass
