...
def moeg_check_results():
    # Set up argument parser
    parser = argparse.ArgumentParser(description="Check numerical correctness for MoEGate.")
    ...
    #Check Results
    num_util.check_results(args.result_path, moeg.dtype)
    pass
