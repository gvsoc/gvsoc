...
parser = argparse.ArgumentParser(description="Generate C header files from a MoECombine configuration file.")
parser.add_argument("input_file",  nargs="?", help="Path to MoECombine configuration python file")
parser.add_argument("output_file", nargs="?", help="Path to MoECombine configuration C header file")
...
moec = MoECombine()
kc.generate_config_C_header("moec", moec, C_header_file, moec.dtype, moec.moec_numer)
