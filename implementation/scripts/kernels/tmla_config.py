...
parser = argparse.ArgumentParser(description="Generate C header files from a FlatMLA configuration file.")
parser.add_argument("input_file",  nargs="?", help="Path to FlatMLA configuration python file")
parser.add_argument("output_file", nargs="?", help="Path to FlatMLA configuration C header file")
...
tmla = FlatMLA()
kc.generate_config_C_header("TMLA", tmla, C_header_file, tmla.dtype, tmla.flatten_numer)
