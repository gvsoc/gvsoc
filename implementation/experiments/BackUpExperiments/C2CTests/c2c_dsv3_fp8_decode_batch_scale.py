...
import utils.c2c_engine as c2c
...
def test():
    ...
    # chip = engine.SoftHier(softhier_root=args.softhier_root, kernel_root=args.kernel_root, output_root=args.output_root, tag="c2c_dsv3_fp8_decode_batch_scale")
    c2c_engine = c2c.C2CEngine(softhier_root=args.softhier_root, output_root=args.output_root, tag="c2c_dsv3_fp8_decode_batch_scale")

    # Test Parameter Initialization
    arch, llm, work, ccfg = test_initialization()
    ...
    for ep in eps:
        for b in bs:
            ...
            # Generate flow
            kernel_flow, spaceA_hbm_plan, spaceB_hbm_plan, c2c_flow = deepseek.deepseek_layer_plan(llm, work, arch, EP=expert_parallelsim, gen_c2c_flow=True)
