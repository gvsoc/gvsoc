...
def test():
    ...
    chip = engine.SoftHier(softhier_root=args.softhier_root, kernel_root=args.kernel_root, output_root=args.output_root, tag="test_dsv3_fp8_decode_kv_spec_effect")
    ...
    kvs  = [1024, 2048, 4096, 8192, 128, 256, 512]
    sps  = [1, 2, 4, 8]
    for kv in kvs:
        for sp in sps:
            # Default
