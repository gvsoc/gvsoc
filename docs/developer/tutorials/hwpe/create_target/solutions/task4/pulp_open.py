...
#### SOLUTION - Change the path from pulp.chips.pulp_open.soc to pulp.chips.pulp_open_hwpe.soc

from pulp.chips.pulp_open_hwpe.soc import Soc

#### SOLUTION - Change the path from pulp.chips.pulp_open.cluster to pulp.chips.pulp_open_hwpe.cluster
...
#### SOLUTION - Change the path from padframe_config_file='pulp/chips/pulp_open/padframe.json' to padframe_config_file='pulp/chips/pulp_open_hwpe/padframe.json'
    ...
    def __init__(self, parent, name, parser, soc_config_file='pulp/chips/pulp_open_hwpe/soc.json',
