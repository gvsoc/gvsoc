...
def roi_to_perfetto(roi_trace, perfetto_trace):
    # TraceViewer events
    events = []
    ...
    with open(perfetto_trace, 'w') as f:
...
def main():
    ...
    # Generate TraceViewer JSON
    roi_to_perfetto(args.input, args.output)
