...
#define ARCH_NUM_CLUSTER_X 1
#define ARCH_NUM_CLUSTER_Y 1
#define ARCH_NUM_CORE_PER_CLUSTER 2
#define ARCH_CLUSTER_TCDM_BANK_WIDTH 8
#define ARCH_CLUSTER_TCDM_BANK_NB 32
...
#define ARCH_SYNC_INTERLEAVE 0x00000010
