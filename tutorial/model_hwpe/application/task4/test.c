...
PI_L1 uint8_t weight[8] = {0x99, 0xaa, 0xbb, 0xcc, 0xdd, 0xea, 0xff, 0xfa};
PI_L1 uint8_t input[8] = {0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88};
PI_L1 uint32_t output[1] = {0x00};
